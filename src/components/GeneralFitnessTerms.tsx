...
export const GENERAL_FITNESS_TERMS: GeneralTerm[] = [
  {
    ...
    full: "I understand that physical training carries risks. I take full responsibility for how I train, push myself, and recover. Bohofit and its trainers are not liable for any injury that occurs because I ignored instructions, hid information, or trained beyond what was prescribed.",
  },
  {
    key: "medical_clearance",
    title: "I have shared all medical conditions honestly.",
    full: "I have disclosed any pre-existing medical condition (heart, BP, diabetes, thyroid, PCOS, surgeries, pregnancy, joint pain, injuries, mental health, medication). If my doctor has restricted certain movements, I have informed Bohofit in writing. If anything changes during my membership, I will inform my coach immediately.",
  },
  {
    key: "injury_risk",
    title: "I understand fitness training carries risk of injury.",
    full: "Even with the best coaching, injuries can occur. By participating, I accept this risk. I agree not to hold Bohofit, its trainers, or its centre liable for any injury that may occur during training, except in cases of proven gross negligence by Bohofit staff.",
  },
  {
  ...
  },
  {
    ...
    full: "Bohofit is a zero-tolerance space for harassment, body-shaming, casteist, religious, or sexist remarks. Any such behaviour will result in immediate termination of membership without refund.",
  },
  {
    key: "media",
    title: "Photo / video on the floor.",
    full: "Bohofit may occasionally photograph / film classes for marketing. If I do not want to be featured, I will tell the coach in writing and we will exclude me. I will not film other members without consent.",
  },
  {
    key: "payment",
    title: "Payment, refund & transfer policy.",
    full: "All fees are GST inclusive. Refunds are not provided once the program starts, except where Bohofit is unable to deliver. Transfers (where allowed) carry an ERP fee of ₹599. Pause balance is fixed per plan and cannot be carried over.",
  },
  {
    key: "data_privacy",
    title: "Data & privacy.",
  ...
  {
    key: "contact_consent",
    title: "I agree to be contacted by Bohofit.",
    full: "Bohofit may reach me on call, WhatsApp or email regarding my program, schedule, payments and important updates. I can opt out of marketing messages at any time.",
  },
];
