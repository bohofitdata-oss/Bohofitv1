...
const paths = [
  {
    ...
    desc: "Group classes that build a habit you actually keep.",
    bullets: ["Spin, Yoga, Pilates, Zumba, Strength, Boxing", "Small batches, real coaches", "Monthly to annual plans"],
    cta: "Start with Bohofit",
  },
  {
    ...
    desc: "Lose 4–8 kg in 8 weeks with diet + training + check-ins.",
    bullets: ["Weight loss, fat loss, strength basics", "PCOS, thyroid, fatty liver friendly", "Visible result guaranteed*"],
  ...
  },
  {
    ...
    tag: "Longevity 1:1",
    icon: HeartPulse,
    headline: "I want to move pain-free",
    desc: "Rehab-style 1:1 coaching for back, knee, neck, mobility.",
    bullets: ["Built for 50+", "Personal coach, twice a week", "Gentle, progressive, sustainable"],
    cta: "Book a consult",
  },
];
